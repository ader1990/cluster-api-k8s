...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CK8sControlPlaneInitializationStatus) DeepCopyInto(out *CK8sControlPlaneInitializationStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CK8sControlPlaneInitializationStatus.
func (in *CK8sControlPlaneInitializationStatus) DeepCopy() *CK8sControlPlaneInitializationStatus {
	if in == nil {
		return nil
	}
	out := new(CK8sControlPlaneInitializationStatus)
	in.DeepCopyInto(out)
	return out
}

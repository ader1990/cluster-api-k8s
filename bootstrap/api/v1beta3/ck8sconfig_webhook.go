...
var _ admission.Defaulter[*CK8sConfig] = &CK8sConfig{}
...
func (c *CK8sConfig) ValidateUpdate(_ context.Context, _, _ *CK8sConfig) (admission.Warnings, error) {
	return []string{}, nil
}
...
func (c *CK8sConfig) Default(_ context.Context, _ *CK8sConfig) error {
	return nil
}
